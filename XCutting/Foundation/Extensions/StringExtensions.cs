...
namespace Bfar.XCutting.Foundation.Extensions
{
    public static class StringExtensions
    {
        ...
        public static DateTime FullConvertToGregorian(this String value)
        {
            string[] parts = value.Split(new string[] { "-", "/", "\\", " " }, StringSplitOptions.RemoveEmptyEntries);
            int[] gregValues = JalaliCalendar.JalaliToGregorian(Convert.ToInt32(parts[0]), Convert.ToInt32(parts[1]), Convert.ToInt32(parts[2]));
            return new DateTime(gregValues[0], gregValues[1], gregValues[2]);
        }
